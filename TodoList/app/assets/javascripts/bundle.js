...
var _todo_api_util = __webpack_require__(84);
...
var fetchTodos = exports.fetchTodos = function fetchTodos() {
  return function (dispatch) {
    return _todo_api_util2.default.fetchTodo().then(function (todos) {
...
var createTodo = exports.createTodo = function createTodo(todo) {
  return function (dispatch) {
    return _todo_api_util2.default.createTodo(todo).then(function (receivedtodo) {
...
window.actions = {};
window.actions.todos = { receiveTodos: receiveTodos, receiveTodo: receiveTodo, removeTodo: removeTodo, fetchTodos: fetchTodos };
...
var _thunk = __webpack_require__(85);
...
var configureStore = exports.configureStore = function configureStore() {
  return (0, _redux.createStore)(_root_reducer.rootReducer, (0, _redux.applyMiddleware)(_thunk2.default));
};
...
var todosReducer = exports.todosReducer = function todosReducer() {
  ...
  switch (action.type) {
    case _todo_actions.RECEIVE_TODOS:
      action.todos.forEach(function (listItem) {
...
exports.stepsReducer = undefined;

var _step_actions = __webpack_require__(61);
...
var stepsReducer = exports.stepsReducer = function stepsReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
  var action = arguments[1];
  ...
  switch (action.type) {
    case _step_actions.RECEIVE_STEPS:
      action.steps.forEach(function (listItem) {
        newState[listItem.id] = listItem;
      });
      return newState;
...
var receiveSteps = exports.receiveSteps = function receiveSteps(steps, id) {
  return {
    type: RECEIVE_STEPS,
    id: id,
    steps: steps
...
window.actions = {};
window.actions.steps = { receiveSteps: receiveSteps, receiveStep: receiveStep, removeStep: removeStep };
...
var _todo_list = __webpack_require__(79);
...
var stepsByTodoId = exports.stepsByTodoId = function stepsByTodoId(state, todoId) {
  var stepItems = Object.values(state.steps);
  var stepList = stepItems.filter(function (stepItem) {
...
var _todo_list_item = __webpack_require__(80);

var _todo_list_item2 = _interopRequireDefault(_todo_list_item);

var _todo_form = __webpack_require__(82);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'ul',
          null,
          this.props.todos.map(function (obj) {
            return _react2.default.createElement(_todo_list_item2.default, { key: obj.id,
              item: obj,
              removeTodo: _this2.props.removeTodo,
              createTodo: _this2.props.createTodo });
          })
        ),
        _react2.default.createElement(_todo_form2.default, { onSubmission: this.props.createTodo })
      );
    }
  }]);
...
var _todo_detail_view = __webpack_require__(81);
...
var TodoListItem = function (_React$Component) {
  ...
  _createClass(TodoListItem, [{
    ...
    key: 'changeDetail',
    value: function changeDetail(detail) {
      var value = this.state.detail === false ? true : false;
    ...
    value: function renderDetailView() {
      if (this.state.detail === true) {
        return _react2.default.createElement(_todo_detail_view2.default, { body: this.props.item.body });
      } else {
        return;
      }
    }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { onClick: function onClick() {
              return _this2.changeStatus(item);
            } },
...
var TodoForm = function (_React$Component) {
  ...
  _createClass(TodoForm, [{
    ...
    value: function submit() {
      ...
      this.props.onSubmission(this.state).then(function () {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', { onChange: this.updateTitle.bind(this),
        ...
        _react2.default.createElement(
          ...
          ' Body ',
          _react2.default.createElement('br', null),
          _react2.default.createElement('textarea', { onChange: this.updateBody.bind(this),
...
exports.default = { fetchTodo: fetchTodo, createTodo: createTodo };
